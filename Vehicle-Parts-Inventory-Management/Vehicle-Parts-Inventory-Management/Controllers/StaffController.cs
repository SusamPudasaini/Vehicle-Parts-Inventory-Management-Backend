...
namespace Vehicle_Parts_Inventory_Management.Controllers
{
    ...
    public class StaffController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetById(int id)
        {
            ...
            return result == null ? NotFound(new { message = $"Staff member with ID {id} not found." }) : Ok(result);
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            return success ? NoContent() : NotFound(new { message = $"Staff member with ID {id} not found." });
        }
    }
}
